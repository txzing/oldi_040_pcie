...
call updatemem.bat -meminfo system_wrapper.mmi -data ..\..\Debug\fsbl.elf -proc system_i/processor_subsystem/microblaze_0 -bit system_wrapper.bit -out download.bit -force
::call:updatememfun
echo %errorlevel%
if exist ..\flash (
    rmdir /s/q ..\flash
