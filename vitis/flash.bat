...
::call program_flash.bat -f fsbl.bin -offset 0 -flash_type mt25ql256-spi-x1_x2_x4 -verify -cable type xilinx_tcf url TCP:127.0.0.1:3121
::call program_flash.bat -f app.bin -offset 0x00D00000 -flash_type mt25ql256-spi-x1_x2_x4 -verify -cable type xilinx_tcf url TCP:127.0.0.1:3121

call program_flash.bat -f BOOT.bin -offset 0x00000000 -flash_type mt25ql256-spi-x1_x2_x4 -verify -cable type xilinx_tcf url TCP:127.0.0.1:3121
